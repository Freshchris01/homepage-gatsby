...
const Impress: FC<MyProps> = () =>
	<Layout>
	{/* <div className='impressum'>
		<h1>Impressum</h1>
		<p>Angaben gemäß § 5 TMG</p>
		<p>Christian Diemers <br> Test<br> 11111 Test <br> </p>
		<p> <strong>Vertreten durch: </strong><br>Christian Diemers<br></p>
		<p><strong>Kontakt:</strong> <br>Telefon: 1111-1111<br>
E-Mail: <a href='mailto:test@test.com'>test@test.com</a></br></p><p><strong>Haftungsausschluss: </strong><br><br><strong>Haftung für Inhalte</strong><br><br>
